...
public class Logic 
    ...
    // Method to find the Area of a Right-Angled Triangle
    public static double rightTriangleArea(double base, double height) {
        double Area = base * height * 0.5 ;
        return Area;
    }

    // Method to find the Perimeter of a Right-Angled Triangle
    ...
    // Method to find the Surface Area of a Box
    public static double boxSurfaceArea(double length, double width, double depth) {
        double SurfaceArea = ((2*length*width)+(2*length*depth)+(2*width*depth));
        return  SurfaceArea;
    }

    // Method to find the Volume of a Sphere
    public static double sphereVolume(double radius) {
        double Volume = ( 4.0 / 3.0 ) * Math.PI * ( radius * radius * radius ) ;
        return Volume ;
    }

    // Method to find the Surface Area of a Sphere
